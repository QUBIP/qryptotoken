...
#[derive(Clone)]
pub struct PrivKey(Box<MLDSA87SigningKey>);

pub struct Signature(Box<MLDSA87Signature>);

pub mod sizes {
    #![allow(dead_code)]
    use super::*;

    pub(crate) const ML_DSA_87_PK_SIZE: usize = PubKey::output_len();
    pub(crate) const ML_DSA_87_SK_SIZE: usize = PrivKey::output_len();
    pub(crate) const ML_DSA_87_SIG_SIZE: usize = Signature::output_len();
}
...
pub fn generate_key_pair(
    ...
    let pair = ml_dsa_87::generate_key_pair(randomness);
