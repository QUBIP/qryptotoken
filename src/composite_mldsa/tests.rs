...
/*
 * DISCLAIMER: The following tests are intended to torture the crypto
 * backend and should be moved to an appropriate place for testing all
 * the crypto backends. Tests in the PKCS#11 context are therefore marked as
 * TODO.
 */

/*
 * The following test keys and signsature are taken as an example from
